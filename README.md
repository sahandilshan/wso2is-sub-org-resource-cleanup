...
2. **Required Tools**:
   - Bash shell
   - Database drivers or relavant librires to connecto to database
...
EXPORT_FILE="/path/to/exported_data.csv" # This will be used to save the information of organizations that is going to clean in each batch.
H2_JAR_PATH="/path/to/h2-2.2.220.jar" # For MSSQL and MySQL, no external JAR required
```
